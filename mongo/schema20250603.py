...
news_validator = {
    "$jsonSchema": {
        ...
        "required": ["link", "_public", "archiv", "showlastday", "image", "home", "monitor", "rang", "bearbeitet", "kommentar", "tags"],
        "properties": {
            "tags": {
            "bsonType": "array",
            "uniqueItems": True,
...
vortragsreihe_validator = {
    "$jsonSchema": {
        ...
        "required": ["sichtbar", "nurintern", "event", "lang_default", "anzeigetage", "kurzname", "title_de", "title_en", "text_de", "text_en", "url", "ort_de_default", "start", "end", "duration_default", "ort_en_default", "gastgeber_default", "sekretariat_default", "_public", "_public_default", "sync_with_calendar", "calendar_url", "rang", "bearbeitet", "kommentar"],
        "properties": {
            "sichtbar": {
                "bsonType": "bool",
            ...
            "nurintern": {
                "bsonType": "bool",
                "description": "Gibt an, ob die Vortragsreihe nur innerhalb des vpn sichtbar sein soll (Promotionen)"
            },
            "event": {
                "bsonType": "bool",
